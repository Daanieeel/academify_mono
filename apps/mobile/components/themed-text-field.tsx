...
const ThemedTextField = ({ type = 'normal', obscureText, isEditable = true, fieldDescription, ref, ...props }: ThemedTextFieldProps) => {
    ...
    return (
        <View style={[
            ...
            {
                fieldDescription && (
                    <ThemedText color={neutral900Color} type='caption'>{fieldDescription}</ThemedText>
                )
            }
            <TextInput
                ref={ref}
                ...
                style={[
                    type == 'normal' ? styles['normal-text-style'] : styles['big-text-style'],
                    {
