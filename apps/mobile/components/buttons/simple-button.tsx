...
const SimpleButton = ({ label, onPress, type, icomoonIcon, dynamicIcon, icomoonIconColor, icomoonIconSize = 24, dynamicIconLeft, customTextColor }: SimpleButtonProps) => {
    ...
    return (
        <Animated.View
            ...
            style={[
                type === 'primary' ? { backgroundColor: neutral900Color, borderColor: neutral700Color } : { backgroundColor: 'transparent', borderColor: neutral200Color },
                styles['main-container'],
                { transform: [{ scale: scaleAnim }] }
            ]}
        >
            {dynamicIconLeft && dynamicIconLeft()}
            <ThemedText type='body' color={customTextColor || (type === 'primary' ? neutral50Color : neutral900Color)} style={[styles.label]}>{label}</ThemedText>
            {icomoonIcon && <IcomoonIcon name={icomoonIcon} size={icomoonIconSize} color={icomoonIconColor || (type === 'primary' ? neutral50Color : neutral900Color)} />}
