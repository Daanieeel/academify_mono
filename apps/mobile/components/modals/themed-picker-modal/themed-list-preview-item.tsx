...
const ThemedListPreviewItem = ({ showRemoveButton = false, ...props }: ThemedListPreviewItemProps) => {
  ...
  return (
    <View style={{
      ...
      {showRemoveButton && <SmallButton customPaddingHorizontal={5} customPaddingVertical={5} type='red' iconName='minus-circle'></SmallButton>
      }
    </View>
  )
}
