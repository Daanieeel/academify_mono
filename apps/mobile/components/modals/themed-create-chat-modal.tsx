...
import ThemedListPreviewItem, { ThemedListPreviewItemProps } from '@/components/modals/themed-picker-modal/themed-list-preview-item'
...
import ThemedImagePickerModal, { IMAGE_URIS } from './themed-image-picker-modal'
        ...
        >
            ...
            <View style={[
                ...
                <ThemedSlider
                    ...
                    options={[APPLICATION_CONSTANTS.CREATE_CHAT_MODAL_SLIDER_OPTION_1, APPLICATION_CONSTANTS.CREATE_CHAT_MODAL_SLIDER_OPTION_2]}
                    ...
                    <ScrollView
                        ...
                        style={styles.chatScrollView}>
                        {
                            MOCK_USERS.map((props, key) => {
                                return (<ThemedPressable disabled onPress={() => { }}>
                                    <ThemedListPreviewItem
                                        borderRadius={18}
                                        key={key}
