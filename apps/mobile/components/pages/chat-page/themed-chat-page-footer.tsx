...
const ThemedChatPageFooter = ({ currentDisplay, setCurrentDisplay }: ThemedChatPageFooterProps) => {
        ...
        <Animated.View style={[
            ...
            <View style={{
                ...
                <ThemedPressable
                    ...
                    <IcomoonIcon name={currentDisplay == 'attachments' ? 'keyboard' : 'plus'} size={25}></IcomoonIcon>
                </ThemedPressable>
                ...
                (
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <ThemedRoundButton label={'Bild'} icomoonIcon={'image'} onPress={() => { }} />
                            <ThemedRoundButton label={'Bild'} icomoonIcon={'image'} onPress={() => { }} />
                            <ThemedRoundButton label={'Kamera'} icomoonIcon={'camera'} onPress={() => { }} />
                            <ThemedRoundButton label={'Kamera'} icomoonIcon={'camera'} onPress={() => { }} />
                            <ThemedRoundButton label={'Umfrage'} icomoonIcon={'poll'} onPress={() => { }} />
                            <ThemedRoundButton label={'Bild'} icomoonIcon={'image'} onPress={() => { }} />
                        </View>
                    </View>
                ) : undefined
