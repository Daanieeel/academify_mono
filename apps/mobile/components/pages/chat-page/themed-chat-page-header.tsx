...
const ThemedChatPageHeader = (props: ThemedChatPageHeaderProps) => {
    ...
    return <SafeAreaView edges={['top']} style={[
        ...
        <View style={{
            ...
            <SmallButton iconSize={25} onPress={onBackButtonPressed} iconName='arrow-left'></SmallButton>
        ...
        <SmallButton iconSize={25} onPress={() => { }} iconName='dots-three-circle'></SmallButton>
    </SafeAreaView>
}
