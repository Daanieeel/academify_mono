...
const ThemedImageMessage = ({ userIsSender = true, ...props }: ThemedImageMessageProps) => {
    ...
    var numberOfPictures = props.sources.length
    ...
    switch (true) {
        ...
        case (numberOfPictures >= 4):
            {
                const scaleFactor = 2.02;
                const backgroundColor = !userIsSender ? useThemeColor({}, 'primary-100') : useThemeColor({}, 'neutral-100')
                const textColor = !userIsSender ? useThemeColor({}, 'primary-900') : useThemeColor({}, 'neutral-900')
                ...
                return (
                    <View style={styles['image-3-4-outer-container']}>
                        ...
                        <View onLayout={onLayout} style={styles['image-2-3-4-inner-container']}>
                            ...
                            styles['placeholder']]}>
                                <IcomoonIcon size={35} color={textColor} name='panorama'></IcomoonIcon>
                                <ThemedText color={textColor} type='caption'>{'+ ' + numberOfPicturesRemaining + ' ' + 'Bilder'}</ThemedText>
                            </View>
                        </View>
                    </View>
