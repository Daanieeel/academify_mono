...
const UserCardPage = () => {
    ...
    return (
        <View style={[styles['main-container'], { backgroundColor: neutral50Color }]}>
            ...
            <View style={[styles['fullscreen-wrapper']]}>
                <Animated.View style={[styles['user-tile'], { backgroundColor: neutral50Color, borderColor: neutral900Color, transform: [{ scale: scaleAnim }] }]}>
                    <ProfilePic size='extra-large' customBorderColor={neutral400Color}></ProfilePic>
                    <IcomoonIcon name='hand-peace' size={60} color={green500Color}></IcomoonIcon>
                    <View style={{ gap: 10, alignItems: 'center' }}>
                        <ThemedText style={{ textAlign: 'center' }} color={neutral900Color} type="heading2">{`${userName}!`}</ThemedText>
                        <ThemedText style={{ textAlign: 'center' }} color={neutral900Color} type="body">{APPLICATION_CONSTANTS.USER_CARD_PAGE_GREETING}</ThemedText>
                    </View>
                </Animated.View>
                <SafeAreaView style={styles['button-wrapper']}>
                    <SimpleButton label={'Weiter'} onPress={handleContinueButtonPress} type={'primary'} icomoonIcon='arrow-right'></SimpleButton>
                </SafeAreaView>
            </View>
