        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: useThemeColor({}, 'neutral-50') }}>
            ...
            <View style={styles['main-container']}>
                <View style={styles['heading-container']}>
                    <IcomoonIcon size={62} name="user-focus" color={neutral900Color}></IcomoonIcon>
                    <ThemedText color={neutral900Color} type="heading2" style={{ textAlign: 'center' }}>Wer bist du?</ThemedText>
                    <ThemedText color={neutral900Color} type="body" style={{ textAlign: 'center' }}>Benutzernamen oder Mail eingeben</ThemedText>
                </View>
                <ThemedTextField
                ...
                <SimpleButton onPress={() => handleContinueButtonPress(text)} label="Weiter" type="primary" icomoonIcon="arrow-right"></SimpleButton>
            </View>
        </SafeAreaView >
    )
}
