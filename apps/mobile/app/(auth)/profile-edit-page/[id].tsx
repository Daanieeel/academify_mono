            ...
            <ScrollView style={styles['scroll-view']}>
                <View style={styles['header-container']}>
                    <View style={styles['text-container']}>
                        <ThemedText style={{ width: '80%', textAlign: 'center' }} type='heading2'>{APPLICATION_CONSTANTS.PROFILE_EDIT_PAGE_HEADING}</ThemedText>
                        <ThemedText style={{ width: '80%', textAlign: 'center' }} type='body'>{APPLICATION_CONSTANTS.PROFILE_EDIT_PAGE_SUBHEADING}</ThemedText>
                    </View>
                    <View style={styles['pic-icon-container']}>
                        <ProfilePic size={'large'}></ProfilePic>
                        <View style={[styles['hairline'], { backgroundColor: neutral400Color }]}></View>
                        <IcomoonIcon name='sparkle' size={70} color={neutral900Color}></IcomoonIcon>
                    </View>
                ...
                <View style={styles['bottom-inset-container']}>

                </View>
            </ScrollView>
            <SafeAreaView style={styles['continue-button-wrapper']}>
                <SimpleButton label={APPLICATION_CONSTANTS.GENERAL_NEXT_PAGE} onPress={handleContinueButtonPress} icomoonIcon='arrow-right' type={'primary'}></SimpleButton>
            </SafeAreaView>
        </View >
    )
}
