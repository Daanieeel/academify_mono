...
const ChatPage = () => {
    ...
    const [footerCurrentDisplay, setFooterCurrentDisplay] = useState<'keyboard' | 'none' | 'attachments'>('none')
    ...
    return (
        <View
            ...
            <ThemedChatPageHeader onChatAboutPressed={onChatAboutPressed}></ThemedChatPageHeader>
            ...
            >
                <FlatList
                    ...
                    renderItem={(item) => <ThemedMessageWrapper {...item.item}></ThemedMessageWrapper>} >
                </FlatList>
