    ...
    return (
        <View style={[styles['main-container'], { backgroundColor: neutral50Color }]}>
            ...
            <SafeAreaView edges={['top']}>
                <Animated.View style={[headerStyle, { overflow: 'hidden' }]}>
                    <ThemedHeader
                        ...
                        headerSearchBar={
                            <ThemedSearchBar
                                placeholder={APPLICATION_CONSTANTS.CHATS_PAGE_SEARCH_BAR_PLACEHOLDER}
                                value={searchText}
                ...
                mockChats.length == 0 ? (
                    <View style={{
                        ...
                        <ThemedErrorBackground
                            ...
                            description={APPLICATION_CONSTANTS.CHATS_PAGE_NO_CHATS_AVAILABLE_DESCRIPTION}
                        >
                        </ThemedErrorBackground>
                    </View>
                ) : undefined
            ...
            <View style={styles['new-chat-button-wrapper']}>
                <SimpleButton icomoonIcon='magic-wand' label={APPLICATION_CONSTANTS.CHATS_PAGE_NEW_CHAT_BUTTON_LABEL} onPress={onNewChatPressed} type={'primary'} ></SimpleButton>
            </View>
        </View>
    )
}
