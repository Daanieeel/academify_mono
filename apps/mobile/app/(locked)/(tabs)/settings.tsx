...
import ThemedSettingsItem, { ThemedSettingsItemProp } from '@/components/pages/settings/themed-settings-item'
    ...
    return (
        <View style={[styles['main-container'], {
            ...
            <SafeAreaView>
                ...
                <ThemedHeader headerTitle={'Einstellungen'} headerSearchBar={
                    <ThemedSearchBar placeholder='Nach Einstellung suchen..' value={searchBarValue} onInputChanged={setSearchBarValue} ></ThemedSearchBar>
                }>
                </ThemedHeader>
            </SafeAreaView>
            ...
            <ScrollView
                ...
                <ThemedDivider style={{ marginVertical: 20, marginHorizontal: 20 }}></ThemedDivider>

                <View style={styles['settings-items-container']}>
                    {
                        settingsItems.map((item, key) =>
                            <ThemedPressable key={key} onPress={settingsActionHandler[item.onPressAction ?? 'default']}>
