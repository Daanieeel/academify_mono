...
const MOCK_CHAT_ABOUT_PAGE_DATA: ChatAboutPageProps = {
    ...
    chatType: 'Gruppe',
    userList: [],
    chatImages: ['https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQQka_c7bNInUCQfyshB5XCKvW2_H-4Wrsug&s', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQQka_c7bNInUCQfyshB5XCKvW2_H-4Wrsug&s'],
    chatFiles: []
}
    ...
    return (
        <View style={[{
            ...
            <SafeAreaView style={styles['header']} edges={['top']}>
                <SmallButton iconName='arrow-left' label={APPLICATION_CONSTANTS.GENERAL_PREVIOUS_PAGE} onPress={onBackButtonPressed}></SmallButton>
                <SmallButton disabled iconName='pencil' label={APPLICATION_CONSTANTS.CHAT_ABOUT_PAGE_EDIT_LABEL} onPress={onEditButtonPressed}></SmallButton>
            </SafeAreaView>
            <ScrollView
                ...
                <View style={{ gap: 5, alignItems: 'center' }}>
                    ...
                    <ThemedText type='caption'>{data.chatType + ' • ' + data.userList.length + ' Mitglieder'}</ThemedText>
                </View>
                <ThemedSearchBar
                ...
                <ThemedBentoBox
                    title={'Geteilte Bilder'}
                    icomoonIcon={'panorama'} >
                    <ScrollView
                        contentContainerStyle={{
                            paddingHorizontal: 15,
                            paddingBottom: 15,
                        ...
                        }}>
                        {
                            data.chatImages.map((imageUri, index) => {
                                return <Image borderRadius={10} height={100} width={100} key={index} source={{ uri: imageUri }}></Image>
                            })
                        }
                    </ScrollView>
                </ThemedBentoBox>
